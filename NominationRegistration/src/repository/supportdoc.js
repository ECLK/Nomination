...
const SUPPORT_DOC_BY_NOMINATION_SELECT_QUERY = `SELECT NS.ID AS SUPPORT_DOC_ID,
                                                ...
                                                ON NS.SUPPORT_DOC_CONFIG_ID=SDCD.SUPPORT_DOC_CONFIG_ID
...
const SUPPORT_DOC_INSERT_BASE_QUERY = `INSERT INTO NOMINATION_SUPPORT_DOC (ID,FILE_PATH,SUPPORT_DOC_CONFIG_ID, NOMINATION_ID,STATUS) VALUES `
const SUPPORT_DOC_UPDATE_BASE_QUERY = `UPDATE NOMINATION_SUPPORT_DOC (ID,FILE_PATH,SUPPORT_DOC_CONFIG_ID, NOMINATION_ID) VALUES `
