...
-- election_module file to maintain election types like 'parliamentary', 'provincial'
-- DIVISION_COMMON_NAME eg:- 'district'
CREATE TABLE IF NOT EXISTS ELECTION_MODULE(
    ID VARCHAR(36) PRIMARY KEY,
    NAME VARCHAR(100) NOT NULL,
    DIVISION_COMMON_NAME VARCHAR(20) # eg: 'district'
)ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS SUPPORT_DOC_CONFIG(
	ID VARCHAR(36) PRIMARY KEY,
	DESCRIPTION VARCHAR(100), #NAME OF THE DOCUMENT
