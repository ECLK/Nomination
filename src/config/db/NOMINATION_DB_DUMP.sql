...
CREATE TABLE IF NOT EXISTS ELECTION_TIMELINE_CONFIG_DATA(
	ELECTION_TIMELINE_ID VARCHAR(36),
	FOREIGN KEY (ELECTION_TIMELINE_ID) REFERENCES ELECTION_TIMELINE_CONFIG(ID) ON UPDATE CASCADE ON DELETE RESTRICT,
	
	ELECTION_ID VARCHAR(36),
	FOREIGN KEY(ELECTION_ID) REFERENCES ELECTION(ID) ON UPDATE CASCADE ON DELETE RESTRICT,
	
	VALUE BIGINT,
	PRIMARY KEY(ELECTION_TIMELINE_ID, ELECTION_ID)
)ENGINE=INNODB;
...
--
-- EC-NOMINATION DATA DUMP FOR V2.5.2
--

-- USE NOMINATION;

INSERT INTO ELECTION_MODULE VALUES ('455cd89e-269b-4b69-96ce-8d7c7bf44ac2', 'parliamentary', 'district');

INSERT INTO ELECTION VALUES ('e40fa40b-fb78-4ad3-b00a-3ee77e42b11f', 'parliamentary-election', 1543862328, 1546195128, 1548873528, 1547577528, '455cd89e-269b-4b69-96ce-8d7c7bf44ac2');
